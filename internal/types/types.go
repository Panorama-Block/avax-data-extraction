...
// Transaction representa uma transação recebida via webhook.
...
// ERC721Transfer representa uma transferência ERC721.
...
// ERC1155Transfer representa uma transferência ERC1155.
...
// InternalTransaction representa uma transação interna na blockchain.
...
// ValidatorMetrics contém métricas de validadores.
type ValidatorMetrics struct {
	ValidatorCount int `json:"validatorCount"`
	DelegatorCount int `json:"delegatorCount"`
}

// TokenInfo contém detalhes de um token.
...
// Chain representa os dados de uma chain.
type Chain struct {
	ChainID         string   `json:"chainId"`
